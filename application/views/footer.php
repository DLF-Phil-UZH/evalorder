<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed'); ?>
			...
			<div id="footer">
				<ul>
					<li class="first">EvalOrder</li>
					<li class="separator"> | </li>
					<li>&copy; <a href="http://www.phil.uzh.ch/fakultaet/dlf.html">Digitale Lehre und Forschung, Philosophische Fakultät, Universität Zürich</a></li>
					<li class="separator"> | </li>
